...
import { validateHarvestBatchResponse, validateResearchDraft } from "./validation.ts";
...
describe("validateResearchDraft", () => {
  it("accepts complete research drafts", () => {
    const result = validateResearchDraft({
      ...
      decision_for_human_review: "Approve if the workflow stays narrow.",
    });
